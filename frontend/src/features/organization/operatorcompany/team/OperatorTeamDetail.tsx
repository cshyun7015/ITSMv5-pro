...
import { Target, X, Info, ShieldCheck, Users } from 'lucide-react';
    ...
    <div className="tw-fixed tw-inset-0 tw-z-[2500] tw-flex tw-items-center tw-justify-center tw-p-6">
      ...
      >
        ...
        <div className="tw-p-10 tw-border-b tw-border-white/5 tw-flex tw-justify-between tw-items-center tw-bg-gradient-to-r tw-from-indigo-600/10 tw-to-transparent">
          <h2 className="tw-text-4xl tw-font-black tw-flex tw-items-center tw-gap-6 tw-tracking-tighter tw-text-white">
            ...
            <div className="tw-flex tw-flex-col">
              <span className="tw-text-3xl tw-line-height-none">Unit Intelligence</span>
              <span className="tw-text-xs tw-text-indigo-400 tw-font-bold tw-uppercase tw-tracking-[0.2em] tw-mt-1">Tactical Core Profile</span>
            </div>
          </h2>
        ...
        <div className="tw-p-12 tw-space-y-12 tw-overflow-y-auto tw-max-h-[60vh]">
          <div className="tw-space-y-8">
            <div className="tw-space-y-3">
              <label className="tw-text-[11px] tw-font-black tw-text-slate-500 tw-uppercase tw-tracking-widest tw-ml-1">Tactical Designation</label>
            ...
            <div className="tw-space-y-3">
              ...
              <div className="tw-bg-white/5 tw-p-8 tw-rounded-[32px] tw-border tw-border-white/5 tw-text-slate-300 tw-leading-relaxed tw-font-medium tw-text-lg shadow-inner italic">
                 "{team.description || 'No operational mandate defined for this tactical unit.'}"
              </div>
            </div>
          </div>
          ...
          <div className="tw-grid tw-grid-cols-2 tw-gap-6">
            <div className="tw-p-6 tw-bg-white/5 tw-rounded-[32px] tw-border tw-border-white/5 tw-space-y-1">
              <div className="tw-text-[10px] tw-text-slate-500 tw-font-bold tw-uppercase tw-tracking-widest">Parent Command</div>
              <div className="tw-text-white tw-font-bold tw-truncate">{team.operatorCompanyName}</div>
            </div>
            <div className="tw-p-6 tw-bg-white/5 tw-rounded-[32px] tw-border tw-border-white/5 tw-space-y-1">
              <div className="tw-text-[10px] tw-text-slate-500 tw-font-bold tw-uppercase tw-tracking-widest">Structural ID</div>
          ...
          <div className="tw-p-8 tw-bg-indigo-500/10 tw-border tw-border-indigo-500/20 tw-rounded-[32px] tw-flex tw-gap-6 tw-items-center">
            ...
            <div className="tw-flex tw-flex-col tw-gap-1">
              <span className="tw-text-xs tw-font-black tw-text-white tw-uppercase tw-tracking-widest">Operational Health Optimal</span>
              <p className="tw-text-[10px] tw-text-indigo-200/60 tw-leading-relaxed tw-font-bold">
                This tactical unit is currently authorized for strategic orchestration and command escalation.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="tw-p-10 tw-bg-black/50 tw-border-t tw-border-white/5 tw-flex tw-justify-end">
          <button onClick={onClose} className="tw-py-4 tw-px-12 tw-bg-white/5 hover:tw-bg-white/10 tw-text-slate-400 hover:tw-text-white tw-rounded-[20px] tw-font-black tw-uppercase tw-tracking-widest tw-text-[11px] tw-transition-all tw-border tw-border-white/5">Close intelligence</button>
        </div>
      </motion.div>
    </div>
  );
