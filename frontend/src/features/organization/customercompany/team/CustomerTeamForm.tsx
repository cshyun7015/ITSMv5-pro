...
import { LayoutGrid, X, ShieldAlert, FileText, Info } from 'lucide-react';
...
const CustomerTeamForm: React.FC<CustomerTeamFormProps> = ({ onClose, team, onSave }) => {
      ...
      >
        <form onSubmit={handleSubmit} className="tw-flex tw-flex-col tw-h-full">
          ...
          <div className="tw-p-12 tw-space-y-10 tw-overflow-y-auto tw-max-h-[60vh]">
            ...
            <div className="tw-p-8 tw-bg-emerald-500/10 tw-border tw-border-emerald-500/20 tw-rounded-[32px] tw-flex tw-gap-6 tw-items-start">
               <div className="tw-w-10 tw-h-10 tw-bg-emerald-600 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-shrink-0 tw-shadow-lg tw-shadow-emerald-500/20">
